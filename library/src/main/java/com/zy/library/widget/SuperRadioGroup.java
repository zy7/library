...
public class SuperRadioGroup extends LinearLayout {
    private static final String LOG_TAG = SuperRadioGroup.class.getSimpleName();
    ...
    public SuperRadioGroup(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(SuperRadioGroup group, int checkedId, boolean isChecked);
    }
